...
export default function FirebaseLogin() {
    ...
    const { loginWithFirebase, loginWithGoogle, loginWithGithub } = useAuth();
    ...
    return (
        <div className="w-full max-w-md">
            ...
            {/* Additional Info */}
            <p className="mt-6 text-xs text-center text-gray-400 font-light">
                By continuing, you agree to Firebase's Terms of Service
            </p>
        </div>
    );
}
